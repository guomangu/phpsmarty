...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     *
     * @api  Smarty::isCached()
     * @link http://www.smarty.net/docs/en/api.is.cached.html
     *
     ...
     * @link http://www.smarty.net/docs/en/api.register.plugin.html
     *
     ...
     * @link http://www.smarty.net/docs/en/api.load.filter.html
     *
     ...
     * @link http://www.smarty.net/docs/en/api.register.filter.html
     *
     * @param string      $type filter type
     ...
     * @link http://www.smarty.net/docs/en/api.register.object.html
     *
